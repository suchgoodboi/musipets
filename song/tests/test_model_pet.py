...
class PetModelTest(TestCase):
    ...
    @patch('song.services.send_request_action_email')
    ...
    @patch('song.services.send_deactivate_email')
    ...
    def test_request_action_email_not_set_activation_fail(self):
        ...
        with patch('song.services.send_request_action_email') as mock_method:
